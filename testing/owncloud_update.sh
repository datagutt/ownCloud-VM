...
sudo -u www-data php /var/www/html/owncloud/occ app:enable contacts
sudo -u www-data php /var/www/html/owncloud/occ app:enable documents
sudo -u www-data php /var/www/html/owncloud/occ app:enable external
...
then
        ...
        sed -i 's/  php_value upload_max_filesize 513M/# php_value upload_max_filesize 513M/g' /var/www/html/owncloud/.htaccess
        sed -i 's/  php_value post_max_size 513M/# php_value post_max_size 513M/g' /var/www/html/owncloud/.htaccess
        sed -i 's/  php_value memory_limit 512M/# php_value memory_limit 512M/g' /var/www/html/owncloud/.htaccess
fi
